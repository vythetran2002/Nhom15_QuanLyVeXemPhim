...
import com.example.adminbooking.Model.Adapter.ShowAllAdapter;
...
public class ViewShow extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        init(view);
        addShowController.LoadAllShow(MainActivityIMP.login.getUserId());
    }

    private void init(View view) {
        rv = view.findViewById(R.id.rvViewShow);
    ...
    public void setAdapter(ArrayList<Show> arrayList){
        ...
        showAdapter = new ShowAllAdapter(arrayList,getContext(), addShowController);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_view_show, container, false);
    }
}